...
function processarCadastroUsuario(requisicao, resposta) {
    ...
    <body>
        ...
        <a class="btn btn-primary" href="/publico/menu.html" role="button">Voltar ao menu</a>
<a class="btn btn-primary" href="/publico/app.html" role="button">Continuar cadastrando</a>
    </body>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM"
        crossorigin="anonymous"></script>
    ...
    resposta.end(`
        <!DOCTYPE html>
            ...
            <body>
                <h1>MENU</h1>
                <ul>
                    <li><a href="publico/app.html">Cadastrar Usuário</a></li>
                </ul>
            </body>
        </html>
    `);
...
app.post('/publico/app.html', processarCadastroUsuario);
